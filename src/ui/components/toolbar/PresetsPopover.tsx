...
export function PresetsPopover() {
  ...
  // Exclude the blank preset from the gallery — blank is accessed via "New"
  const galleryPresets = newFilePresets.filter((p) => p.id !== 'blank')
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div
            className="absolute left-0 top-full z-50 mt-px w-96"
            style={{
          ...
          >
              ...
              <div className="grid grid-cols-2 gap-1.5">
                {galleryPresets.map((preset) => (
                  <button
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = 'var(--fenix-active)'
                      e.currentTarget.style.borderColor = 'rgba(255,122,61,0.3)'
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.background = 'var(--fenix-row)'
            ...
            <div
              className="px-3 py-2 text-[10px] text-(--fenix-text-muted)"
