...
export const cinematicExplosionSources: readonly ExplosionSource[] = [
  source([0.5, 0.11, 0.5], 0.3, 0.03, 4.74, 3.4, 9.0, 2.0, 128.05, 128.0, 48.8),
  source([0.7, 0.1, 0.5], 0.2, 6.03, 4.74, 12.4, 24.0, 2.0, 32.05, 48.0, 24.8),
  source([0.7, 0.1, 0.3], 0.2, 4.03, 4.74, 6.4, 24.0, 2.0, 32.05, 24.0, 96.8),
